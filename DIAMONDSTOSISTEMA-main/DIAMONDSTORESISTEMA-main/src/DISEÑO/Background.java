...
public class Background extends JComponent {
    ...
    public Background() {
        image = new ImageIcon(getClass().getResource("/imagenes/login.png"));
    }
    ...
    private void createBlurImage(Graphics2D g) {
        ...
        if (width > 0 && height > 0) {
            ...
            Shape shape = new FancyBorderRadius(width, height, "51% 49% 50% 50% / 51% 49% 51% 49%").getShape();
            g2.fill(shape);
